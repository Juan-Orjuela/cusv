...
function createHomepageGoogleMap(_latitude,_longitude){
    ...
    if( document.getElementById('mapa-ubicacion') != null ){
        $.getScript("assets/js/locations-ubicacion.js", function(){
            ...
            for (i = 0; i < locations.length; i++) {
                ...
                pictureLabel.src = locations[i][2];//Se cambio el icono
                ...
                var marker = new MarkerWithLabel({
                    ...
                    map: map,
                    icon: 'img/ubicacion/marcador-ubicacion.png',
            ...
            $('#mapa-ubicacion').removeClass('fade-map');
        ...
        $('.geo-location').on("click", function() {
            if (navigator.geolocation) {
                $('#mapa-ubicacion').addClass('fade-map');
...
function createHomepageOSM(_latitude,_longitude){
    ...
    if( document.getElementById('mapa-ubicacion') != null ){
        $.getScript("assets/js/locations-ubicacion.js", function(){
            ...
            for (var i = 0; i < locations.length; i++) {
                var _icon = L.divIcon({
                    html: '<img src=" '+ locations[i][2] +'">',//se cambio el icono
                    iconSize:     [48, 48],
                    iconAnchor:   [20, 48],
                    popupAnchor:  [0, -48]
                });
                var title = locations[i][0];
                var marker = L.marker(new L.LatLng(locations[i][0],locations[i][1]), {
                    title: title,
                    icon: _icon
                });
                marker.bindPopup(
