    ...
    if( document.getElementById('map') != null ){
        $.getScript("assets/js/locations.js", function(){
            ...
            for (i = 0; i < locations.length; i++) {
                ...
                pictureLabel.src = "img/barras-cusezar.png";//Se cambio el icono
                ...
                boxText.innerHTML =
                        ...
                        //Nuevo infobox
                        '<div class="cus-box">'+
                            '<div class="cus-box-img">'+
                                '<img src="' + locations[i][6] + '" alt="' + locations[i][0] + ' Fachada">'+
                                '<img src="' + locations[i][1] + '" alt="' + locations[i][0] + ' logo" class="logo">'+
                            '</div>'+
                            '<div class="cus-box-info">'+
                                '<div class="valor">Desde $<span>' + locations[i][2] + '</span></div>'+
                                '<div class="area"><span class="subtit">Área construida</span><span class="desde">' + locations[i][7] + '</span> m<sup>2</sup> - <span class="hasta">' + locations[i][8] + '</span> m<sup>2</sup></div>'+
...
function createHomepageOSM(_latitude,_longitude){
    ...
    if( document.getElementById('map') != null ){
        $.getScript("assets/js/locations.js", function(){
            ...
            for (var i = 0; i < locations.length; i++) {
                var _icon = L.divIcon({
                    html: '<img src="img/barras-cusezar.png>',//se cambio el icono
                    iconSize:     [40, 48],
                    iconAnchor:   [20, 48],
                    popupAnchor:  [0, -48]
                });
